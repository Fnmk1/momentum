...
export default function TermsOfUse() {
  return (
    <div className="bg-black text-neutral-300 min-h-screen">
      {/* Nav */}
      <nav className="fixed top-0 inset-x-0 z-50 bg-black/85 backdrop-blur-xl border-b border-white/[0.04]">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-28 pb-20">
        ...
        <section className="mb-20">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">شروط الاستخدام</h1>
          <p className="text-neutral-500 mb-10">آخر تحديث: 7 مارس 2026</p>
          ...
          <div className="space-y-8 text-neutral-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">١. وصف الخدمة</h2>
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٢. الاشتراك والدفع</h2>
              <ul className="list-disc list-inside space-y-2 mr-4">
                <li><strong className="text-neutral-200">اسم الاشتراك:</strong> Momentum Pro</li>
                <li><strong className="text-neutral-200">مدة الاشتراك:</strong> شهري (يتجدد تلقائياً كل شهر)</li>
                <li><strong className="text-neutral-200">السعر:</strong> 34.99 ريال سعودي شهرياً</li>
                <li><strong className="text-neutral-200">الفترة التجريبية:</strong> 3 أيام مجانية عند الاشتراك لأول مرة</li>
                <li><strong className="text-neutral-200">الدفع:</strong> يتم خصم المبلغ من حساب Apple ID الخاص بك عند تأكيد الشراء</li>
                <li><strong className="text-neutral-200">التجديد التلقائي:</strong> يتجدد الاشتراك تلقائياً ما لم يتم إلغاؤه قبل 24 ساعة على الأقل من نهاية الفترة الحالية</li>
                <li><strong className="text-neutral-200">إدارة الاشتراك:</strong> يمكنك إدارة اشتراكك أو إلغاؤه من إعدادات حساب Apple ID الخاص بك في أي وقت</li>
                <li><strong className="text-neutral-200">الفترة التجريبية:</strong> أي جزء غير مستخدم من الفترة التجريبية المجانية سيُلغى عند شراء اشتراك</li>
              </ul>
            </div>

            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٣. حسابك</h2>
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٤. الاستخدام المقبول</h2>
              <ul className="list-disc list-inside space-y-1 mr-4">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٥. إخلاء المسؤولية الصحية</h2>
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٦. المحتوى المقدم من المستخدمين</h2>
              <ul className="list-disc list-inside space-y-1 mr-4">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٧. تعديل الخدمة والشروط</h2>
              <p>يحق لنا تعديل أو إيقاف أي جزء من الخدمة في أي وقت. سننبهك بأي تغييرات جوهرية على هذه الشروط عبر التطبيق.</p>
            </div>

            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٨. إنهاء الاستخدام</h2>
              <p>يمكنك حذف حسابك في أي وقت من إعدادات التطبيق. عند الحذف، ستُزال جميع بياناتك الشخصية من خوادمنا.</p>
            </div>

            <div>
              <h2 className="text-xl font-semibold text-white mb-3">٩. التواصل</h2>
              <p>لأي استفسار حول هذه الشروط:</p>
              <p className="mt-2">البريد الإلكتروني: <a href="mailto:info@momentumsup.com" className="text-[#2997ff] hover:underline">info@momentumsup.com</a></p>
            </div>
          </div>
        </section>
        ...
        <section dir="ltr" className="text-left">
          ...
          <p className="text-neutral-500 mb-10">Last updated: March 7, 2026</p>
          ...
          <div className="space-y-8 text-neutral-400 leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">2. Subscription & Payment</h2>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong className="text-neutral-200">Subscription name:</strong> Momentum Pro</li>
                <li><strong className="text-neutral-200">Subscription length:</strong> Monthly (auto-renews every month)</li>
                <li><strong className="text-neutral-200">Price:</strong> 34.99 SAR per month</li>
                <li><strong className="text-neutral-200">Free trial:</strong> 3-day free trial for first-time subscribers</li>
                <li><strong className="text-neutral-200">Payment:</strong> Payment will be charged to your Apple ID account upon confirmation of purchase</li>
                <li><strong className="text-neutral-200">Auto-renewal:</strong> Your subscription automatically renews unless it is cancelled at least 24 hours before the end of the current period</li>
                <li><strong className="text-neutral-200">Manage subscription:</strong> You can manage or cancel your subscription from your Apple ID account settings at any time</li>
                <li><strong className="text-neutral-200">Free trial:</strong> Any unused portion of a free trial period will be forfeited when you purchase a subscription</li>
              </ul>
            </div>
            ...
            <div>
              <h2 className="text-xl font-semibold text-white mb-3">7. Service & Terms Modifications</h2>
            ...
            <div>
              ...
              <p className="mt-2">Email: <a href="mailto:info@momentumsup.com" className="text-[#2997ff] hover:underline">info@momentumsup.com</a></p>
            </div>
          </div>
        </section>
